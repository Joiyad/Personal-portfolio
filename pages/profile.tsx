    ...
    <div>
      ...
      <div className="flex justify-center flex-col-reverse md:flex-row gap-10 px-8 md:pl-28 py-32">
        <div className="w-auto md:w-[600px] gap-5 text-center md:text-left">
          ...
          <p className="text-4xl text-purple-700 mt-2">Student at NIT Hamirpur</p>
          <p className="text-xl mt-2 text-gray-300">I am 3rd year student at National Institute of Technology, Hamirpur.My passion is to become a software developer that can solve different industrial and real-life problems. I am interested in web development and blockchain development. I have many skills to contribute including React.js, Node.js, MongoDB, writing smart contracts and knowledge of ethereum. Want to know more about my technical skills<ArrowDownwardIcon /></p>
